...
const clientSegments = [
  {
    ...
    logos: [
      { name: "Global Green Engineer", sector: "Engineering & Sustainability" },
      { name: "Stayhook", sector: "Co-Living & Real Estate" },
      { name: "Stayfurnish", sector: "Furniture & Home Services" },
      { name: "Fair Welfare Foundation", sector: "Non-Profit & Social Welfare" },
      { name: "Fair Property Pvt. Ltd.", sector: "Real Estate" },
      { name: "OptiThrift Aitech Pvt. Ltd.", sector: "AI & Technology" },
      { name: "Afsana Atmanirbhar Mahila Samiti", sector: "Women Empowerment & NGO" },
      { name: "Ms Onlinks Web Services Private Limited", sector: "IT & Web Services" },
      { name: "M/S Elite Packaging and Ors", sector: "Packaging & Manufacturing" },
      { name: "Loyya Buildcon Pvt. Ltd.", sector: "Construction & Real Estate" },
      { name: "Jamana Jeo Tec", sector: "Technology" },
      { name: "Bada Vakeel", sector: "Legal Services" },
      { name: "ALSA International", sector: "International Trade" },
    ],
  },
];
