  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-transparent px-8 py-6 md:w-[450px]"
            style={{
              background: "#3C2A21",
            }}
            key={item.name}
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-white/85 font-normal">
                    {item.name}
                  </span>
